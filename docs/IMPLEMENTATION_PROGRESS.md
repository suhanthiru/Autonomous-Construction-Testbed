...
|---|---|---|
| Pinned runtime and CPU contracts | Implemented foundation | Fresh release install and all integration gates |
...
| Four-joint procedural machine | Cutting-edge cycle deposits 0.4224 kg; fails unchanged 0.5 kg goal | Successful task, repeated cycles and actuator checks |
| Policy runner and recording | External policy, typed dataset loader, task outcomes and BC fit executed | Independent closed-loop trained-policy evaluation |
