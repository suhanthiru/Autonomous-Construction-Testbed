"""Recompute the three-level digging timestep comparison."""
...
assert [r["dt_s"] for r in records] == [0.0004, 0.0002, 0.0001]
changes = []
...
print(json.dumps(dict(audits=audits, timestep_s=[r["dt_s"] for r in records],
                      ...
                      interpretation=("Force changes grow under refinement; "
